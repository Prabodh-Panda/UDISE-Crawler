...
def crawl_range(pincodes):
    for pincode in pincodes:
        pincode_radio = driver.find_element(By.ID, "byPinCodeOnSearchPage")
        pincode_radio.click()

        search_field = driver.find_element(By.ID, "search")
        search_field.send_keys(pincode)

        submit_btn = driver.find_element(By.CLASS_NAME, "btn-block")
        submit_btn.click()
